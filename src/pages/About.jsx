...
function About() {
  return (
    <div>
        ...
        <div>
          <h2 className='text-2xl text-center mb-4'>Author <a className='link text-teal-300 hover:text-violet-600' href="https://t.me/asrorbek_477">Asrorbek</a> (Asrorbek Saidmurodov)</h2>
    ...
    <div className="timeline-middle">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
        ...
        <div className='flex justify-center items-center gap-4 mb-10'>
          <a href="https://github.com/Asrorbek477" target="blanck"><VscGithub className="w-7 h-7 hover:text-violet-600"/></a>
